        ...
        <div className='sticky top-0 z-10 '>
            ...
            <div className='' style={{
                ...
                <div className='flex justify-between '>
                    <p className='font-bold text-blue-800 text-3xl mt-4 ml-8'>Krati Saini</p>
                    <div className='flex space-x-3 font-semibold text-lg mt-4 mr-96 bg-slate-300 rounded-lg pl-8 pr-8 shadow-lg shadow-blue-400'>
